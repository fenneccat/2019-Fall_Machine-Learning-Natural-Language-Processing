...
Original file is located at
    https://colab.research.google.com/drive/13n2tWRmi7GprpLe6S7ePzL8tZAQuzKGD
"""
...
def encode_text(sentences, vectorizer=None, max_len=None, msg_prefix="\n", verbose=True):
    ...
    for s in sentences:
        ...
        for token in tokens:
          if token in vocab:
            encoded_sentence.append(vocab[token]+1)
...
def build_model(learning_rate,
    ...
    logits = tf.matmul(outputs, weight) + bias  # Use weight and bias
